//user
export const REQUEST_LOGIN = 'goldenchoice/login';
export const REQUEST_LOGIN_SUCCESS = 'goldenchoice/login_success';
export const REQUEST_LOGIN_FAIL = 'goldenchoice/login_fail';
