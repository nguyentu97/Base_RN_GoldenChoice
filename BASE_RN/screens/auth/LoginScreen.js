...
export class LoginScreen extends Component {
    ...
    getData() {
        ...
        // reactotron.log(this.props.loginState)
        // this.props.requestLogin()
        // this.props.requestLogin('hello')
        // reactotron.log(this.props.requestLogin('hello'))
    ...
    render() {
        ...
        return (
            <View style={{
                ...
                <TouchableOpacity style={styles._viewButton}
                    onPress={
                        () => {
                            //     if (this.state.email.trim().length == 0 || this.state.password.trim().length == 0) {
                            //         showMessages(I18n.t('notification'), I18n.t('empty_value'))
